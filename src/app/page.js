      ...
      <section className="manifesto">
        <div className="container">
          <div className="principle">
            <h3>1. Simple is understanding.</h3>
            <div className="quote">
          ...
          <div className="principle">
            <h3>2. Taste what you cook for others</h3>
            <p>You&apos;ve got to always taste what you cook because how can you cook for others if you&apos;re not confident that what you made is good? How can you share you software with others if you never actually use it yourself to see if it actually is something good? <span className="highlight">Use your own software. Taste your cook. Adjust if needed.</span>.</p>
          </div>

          <div className="principle">
            <h3>3. Trying to sell to a country.</h3>
            <p>Not everybody wants what you have. Not everybody knows what you have in the first place. <span className="highlight">Focus comes from being specific</span> on what you&apos;re trying to do. If you&apos;re not specific you&apos;re focusing on everyone and everything and reaching no one. Software should know what it stands for..</p>
          </div>
          ...
          <div className="principle">
            <h3>6. Cluttered Desk</h3>
            <p>For as long I can remember my room had always been simple, organized and clean. I took inspiration from Goodbye, Things by Fumio Sasaki and that picture from Steve Jobs sitting in his apartment with only some music records, papers and a lamp. Until recently when searching the internet, I found another picture from this guy. In his office. With BANGING clutter all around. This was when the iPhone and iMac were released and I had a revelation. <span className="highlight">When you have everything out in front of you it is easier to connect dots between concepts and ideas</span>. Software should be the desk of the user.</p>
          </div>
